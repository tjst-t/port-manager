...
func TestGenerateHostname(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			suffix:   "example.com",
			expected: "api--feature-xyz--palmux.example.com",
		},
		{
			name:     "default",
			worktree: "main",
			...
			pattern:  "{name}--{worktree}--{repo}",
			suffix:   "example.com",
			expected: "default--main--palmux.example.com",
		},
		{
			name:     "api",
			...
			pattern:  "{name}--{worktree}--{repo}",
			suffix:   "example.com",
			expected: "api--feature-slash--palmux.example.com",
		},
		{
			name:     "api",
			worktree: "main",
			...
			pattern:  "{name}--{worktree}--{repo}",
			suffix:   "example.com",
			expected: "api--main--my-repo.example.com",
		},
	}
